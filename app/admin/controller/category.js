...
module.exports = class extends Base {
    ...
    listAction() {
        ...
        return _asyncToGenerator(function* () {
            ...
            const count = yield model.where({ parent_id: id }).count();
            const data = yield model.where({ parent_id: id }).select();
            return _this6.success({ count: count, data: data });
        })();
    }
